...
atomsk screw_Ni_40nm_pad_mod.cfg data.screw_Ni.cfg


#rm *.cfg *.imd *.xsf screw_Ni.lmp

#atomsk screw_Ni.cfg -select random 1293502 Ni -sub Ni Co NiCo.cfg
...
atomsk data.screw_Ni.cfg -select in sphere 0.85*box 0.50*box 0.50*box 48.4 -rmatom select final.cfg lmp

mv final.lmp data.Ni_screw_void
