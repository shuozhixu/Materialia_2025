...
atomsk --create CsCl 2.882 Al Ni orient [1-1-2] [110] [1-11] -duplicate 61 131 60 B2.cfg

atomsk B2.cfg -select out sphere 366.619 267.472 150.613 48.3 -rmatom select final1.cfg

atomsk --merge 2 final.cfg final1.cfg output.cfg lmp

mv output.lmp data.HEA_screw_B2_non-random
