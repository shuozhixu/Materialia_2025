...
atomsk --create L12 3.541 Ni Al orient [-110] [111] [11-2] -duplicate 86 87 35 L12.cfg   #Ni3Al

atomsk L12.cfg -select out sphere 366.619 267.472 150.613 46.3 -rmatom select final1.cfg

atomsk --merge 2 final.cfg final1.cfg output.cfg lmp

mv output.lmp data.HEA_screw_L12_non-random
