...
atomsk --create CsCl 2.882 Al Ni orient [1-11] [110] [-112] -duplicate 80 123 43 B2.cfg

atomsk B2.cfg -select out sphere 342.65 250.6795 151.317 45.3 -rmatom select final1.cfg
...
mv output.lmp data.HEA_edge_B2_non-random
