...
atomsk data.NiCoCrFeAl_random_screw.cfg -select in sphere 0.85*box 0.50*box 0.50*box 48.4 -rmatom select sphere.cfg lmp

atomsk --create fcc 3.541 Ni orient [-110] [111] [11-2] -duplicate 172 87 70 new_Ni.cfg
...
mv output.lmp data.HEA_screw_L12_random
