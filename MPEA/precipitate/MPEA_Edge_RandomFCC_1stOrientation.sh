...
atomsk --create fcc 3.541 Ni orient [-110] [111] [11-2] -duplicate 162 82 70 new_Ni.cfg

#atomsk --create L12 3.541 Ni Al orient [-110] [111] [11-2] -duplicate 81 82 35 L12.cfg   #Ni3Al

atomsk new_Ni.cfg -select out sphere 344.592 252.1 152.175 48.3 -rmatom select sphere_Ni.cfg

atomsk sphere_Ni.cfg -select random 10630 Ni -sub Ni Al sphere_NiAl.cfg
...
mv output.lmp data.HEA_edge_L12_random
